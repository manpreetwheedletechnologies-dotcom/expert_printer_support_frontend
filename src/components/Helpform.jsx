...
// Saves form submission to MongoDB via POST /api/leads
// Free Consultation form → stored in leads collection with source: "help_form"
    ...
    try {
      const res = await fetch(`${API_BASE}/api/leads`, {
        ...
        body: JSON.stringify({
          ...
          printerModel: formData.model.trim(),
          source:       "help_form",        // distinguishes from contact_form
          issueType:    "other",
        }),
      });
      ...
      console.error("[Helpform] Submission failed:", err.message);
      ...
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Need assistance today? Fill in the details and our best expert will
            reach out to you for your free consultation.
          </p>
